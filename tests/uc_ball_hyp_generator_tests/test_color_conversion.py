...
class TestDatasetPipelineOptimization:
    ...
    def test_augmentation_pipeline_equivalence(self) -> None:
        ...
        from uc_ball_hyp_generator.dataset_handling import augment_image_test_mode, train_augment_image
        ...
        yuv_result, label_result = augment_image_test_mode(rgb_chw, label)
