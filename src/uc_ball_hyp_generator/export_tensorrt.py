...
def create_tensorrt_engine(
    ...
    conversion_kwargs: dict[str, Any] = {"fp16_mode": fp16, "max_batch_size": max_batch_size}
    ...
    if int8:
        ...
        conversion_kwargs.update({"int8_mode": True, "int8_calib_dataset": calibration_data})

    with torch.no_grad():
        model_trt = torch2trt(model, [dummy_input], **conversion_kwargs)
