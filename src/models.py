...
class Conv2dBn(nn.Module):
    def __init__(self, in_channels, nb_filter, kernel_size, stride=1, padding=0, activation='relu'):
        super().__init__()
...
class BigLittleReduction(nn.Module):
    def __init__(self, in_channels, filter_count, activation='relu'):
        super().__init__()
...
def create_network_v2(input_height, input_width):
