...
model_file = "/home/tkalbitz/PycharmProjects/uc-ball-hyp-generator/model/yuv_2021-05-22-09-23-23/weights.balls.284-0.955393-1.368752.h5"
...
for s in range(steps):
    ...
    pred = model.predict_on_batch(image_batch[0])
